...
The function \verb!etp! takes as input an $n \times n$ positive definite matrix \verb!A!, and returns the solution to the educational testing problem using \verb!sqlp!.
